...
public class MathParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, MathGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getVariableInitAccess().getGroup(), "rule__VariableInit__Group__0");
			builder.put(grammarAccess.getVariablesAccess().getVariablesAssignment(), "rule__Variables__VariablesAssignment");
			...
			builder.put(grammarAccess.getVariableUseAccess().getInExpAssignment_1(), "rule__VariableUse__InExpAssignment_1");
			builder.put(grammarAccess.getVariableUseAccess().getInVariableInitAssignment_2(), "rule__VariableUse__InVariableInitAssignment_2");
			builder.put(grammarAccess.getVariableInitAccess().getNameAssignment_2(), "rule__VariableInit__NameAssignment_2");
			builder.put(grammarAccess.getVariableInitAccess().getInitAssignment_4(), "rule__VariableInit__InitAssignment_4");
			builder.put(grammarAccess.getVariableInitAccess().getStatementAssignment_6(), "rule__VariableInit__StatementAssignment_6");
		}
	}
