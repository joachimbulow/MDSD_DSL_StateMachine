...
public interface MathPackage extends EPackage
{
   ...
   * @ordered
   */
  int EXTERNAL_CALL__EXTERNAL = EXPRESSION_FEATURE_COUNT + 0;
   ...
   * @ordered
   */
  int EXTERNAL_CALL__ARGUMENTS = EXPRESSION_FEATURE_COUNT + 1;
  ...
  /**
   * Returns the meta object for the reference '{@link dk.sdu.mmmi.mdsd.math.ExternalCall#getExternal <em>External</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the reference '<em>External</em>'.
   * @see dk.sdu.mmmi.mdsd.math.ExternalCall#getExternal()
   * @see #getExternalCall()
   * @generated
   */
  EReference getExternalCall_External();

  /**
   * Returns the meta object for the containment reference list '{@link dk.sdu.mmmi.mdsd.math.ExternalCall#getArguments <em>Arguments</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the containment reference list '<em>Arguments</em>'.
   * @see dk.sdu.mmmi.mdsd.math.ExternalCall#getArguments()
   * @see #getExternalCall()
   * @generated
   */
  ...
  interface Literals
  {
     ...
     * @generated
     */
    EReference EXTERNAL_CALL__EXTERNAL = eINSTANCE.getExternalCall_External();
