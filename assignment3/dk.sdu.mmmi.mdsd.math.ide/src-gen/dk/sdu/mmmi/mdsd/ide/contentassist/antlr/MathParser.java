...
public class MathParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, MathGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getExternalCallAccess().getExternalAssignment_1(), "rule__ExternalCall__ExternalAssignment_1");
			builder.put(grammarAccess.getExternalCallAccess().getArgumentsAssignment_3(), "rule__ExternalCall__ArgumentsAssignment_3");
			builder.put(grammarAccess.getExternalCallAccess().getArgumentsAssignment_4_1(), "rule__ExternalCall__ArgumentsAssignment_4_1");
